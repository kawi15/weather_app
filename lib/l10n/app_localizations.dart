...
abstract class AppLocalizations {
  ...
  /// No description provided for @appHeader.
  ///
  /// In en, this message translates to:
  /// **'Weather app'**
  String get appHeader;

  /// No description provided for @labelTextField.
  ///
  /// In en, this message translates to:
  /// **'Enter the city'**
  String get labelTextField;

  /// No description provided for @downloadWeather.
  ///
  /// In en, this message translates to:
  /// **'Download weather'**
  String get downloadWeather;
  ...
  /// No description provided for @noFavoriteCities.
  ///
  /// In en, this message translates to:
  /// **'No favorite cities'**
  String get noFavoriteCities;
